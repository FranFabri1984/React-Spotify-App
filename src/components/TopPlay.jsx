...
const TopPlay = () => {
  ...
  return (
          <div ref={divRef} className="xl:ml-6 ml-0 xl:mb-0 mb-6 flex-1 
               xl:max-w-[380px] max-w-full flex flex-col">
             ...
             <div className="flex flex-row justify-between items-center">
               ...
               <Swiper slidesPerView="auto" spaceBetween={15} freeMode centeredSlides 
                centeredSlidesBounds modules={[FreeMode]} className="mt-4">
                {topPlays?.map((song, i) => (
